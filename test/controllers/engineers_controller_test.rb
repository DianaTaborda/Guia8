...
class EngineersControllerTest < ActionController::TestCase
  ...
  test "should create engineer" do
    assert_difference('Engineer.count') do
      post :create, engineer: { dependency: @engineer.dependency, fullname: @engineer.fullname, proyects_id: @engineer.proyects_id, studies: @engineer.studies }
    end
  ...
  test "should update engineer" do
    patch :update, id: @engineer, engineer: { dependency: @engineer.dependency, fullname: @engineer.fullname, proyects_id: @engineer.proyects_id, studies: @engineer.studies }
    assert_redirected_to engineer_path(assigns(:engineer))
  end
